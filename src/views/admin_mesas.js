                        ...
                        return (
                            <div className="container mt-5">
                                <div className="row align-items-center" id="row_admin_mesas">
                                    <div className="col-5">
                                        <Link className="btn btn-dark btn-block rounded-pill border-white" to="/admin_home/mesas/settings">Configuracion Mesas </ Link>
                                    </div>
                                    <div className="col-2"></div>
                                    <div className="col-5">
                                        <Link className="btn btn-dark btn-block rounded-pill border-white" to="/garzon_home">Live Mesas</ Link>
                                    </div>
                                </div>
                            </div>
                        )
