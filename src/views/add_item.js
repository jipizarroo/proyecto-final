    ...
    return (
        <div className="container mt-5">
            ...
            <div className="row pt-5">
                ...
                <div className="col-md-3">
               <button type="submit" onClick={e => actions.agregarProducto(props.history)} className="btn btn-secondary mr-3">
                  Agregar
                  </button>
                  
               <Link className="navbar-brand" to="/productos"><button type="submit" className="btn btn-success">
                   Cancelar
                   </button>
                   </Link>
                </div>
